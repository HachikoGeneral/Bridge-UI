    ...
    <header className={clsx(classes.root)}>
      <div className={classes.left}>
        ...
        <div className={classes.mainTitle}>
          <Typography variant="h4">Cross-Chain Bridge <small>(Beta)</small></Typography>
        </div>
        <div className={classes.headerLinks}>
			<a href="https://wxlc.liquidchain.net/" target="_blank" style={{padding: '0px 20px 0px 0px', fontSize: '15px'}}>WXLC</a>
			<a href="https://docs.liquidchain.net/" target="_blank" style={{padding: '0px 20px 0px 0px', fontSize: '15px'}}>Docs</a>
			<a href="https://linktr.ee/Liquidchain" target="_blank" style={{padding: '0px 20px 0px 0px', fontSize: '15px'}}>Resources</a>
        </div>
      </div>
