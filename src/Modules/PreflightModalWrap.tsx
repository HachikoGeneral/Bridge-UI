  ...
  return (
    ...
    >
      <ul>
        ...
        <li>
          <Typography variant="h5">
            ◻️ You will not be able to cancel the transaction once you submit it.
          </Typography>
        </li>
        <li>
          <Typography variant="h5">
            ◻️ Your transaction could get stuck for an indefinite amount of time
          </Typography>
        </li>
        <li>
          <Typography variant="h5">
        ...
        <li>
          <Typography variant="h5">
            ◻️ The transaction fee may be higher than expected. <br /><br />
          </Typography>
        </li>
      </ul>
